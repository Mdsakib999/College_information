    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button type="submit" className="w-[50%] mx-auto btn btn-primary" gradientDuoTone="pinkToOrange">
          Register
        </button>
        </div>
        <p className="mt-4">
      ...
      <button onClick={handelGoogleSignIn} className="b bg-slate-200 rounded-lg my-5 ml-6 py-2 px-5 font-bold "> <i class="fa-brands fa-google"></i> Login with Google</button>
      </div>
    </div>
    );
};
